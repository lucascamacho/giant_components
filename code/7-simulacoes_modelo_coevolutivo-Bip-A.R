...
networks_files <- list.files(here("data/bip_matrices_asymmetric"), pattern="*.txt") #Network names
networks_path <- list.files(here("data/bip_matrices_asymmetric"), pattern="*.txt", full.names=TRUE) #Networks file paths
